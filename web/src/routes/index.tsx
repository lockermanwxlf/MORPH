...
function RouteComponent() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <article className="bg-slate-800/50 border border-slate-700 rounded-lg p-8">
                            ...
                            <p className="text-slate-300">
                                MORPH is a modular open-source robotic programming hub designed to make robotics accessible,
                                customizable, and scalable for students, educators, and hobbyists worldwide.
                            </p>
                        </article>

                        {/* Mission Card */}
                        <article id="why-us" className="bg-slate-800/50 border border-slate-700 rounded-lg p-8">
                        ...
                        {/* Shop Card */}
                        <article id="shop" className="bg-slate-800/50 border border-slate-700 rounded-lg p-8">
                            <h3 className="text-2xl font-bold mb-4">Shop Our Product</h3>
                            <p className="text-slate-300 mb-6">
                                Get MORPH base kits, expansion modules, and accessories. Pre-configured to work out of the box.
                            </p>
                            <button
            ...
            {/* CTA Band Section */}
            <section id="schools" className="py-20 px-4 bg-gradient-to-r from-teal-900/30 to-blue-900/30 border-t border-slate-700">
                <div className="max-w-3xl mx-auto text-center">
                    <h3 className="text-4xl font-bold mb-4">Bring MORPH to Your School</h3>
                    <p className="text-slate-300 text-lg mb-8">
                        Curriculum-ready kits, educator guides, and workshops to jumpstart robotics programs.
                    </p>
                    <button
