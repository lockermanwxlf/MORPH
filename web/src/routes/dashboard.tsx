...
function RouteComponent() {
	...
	return (
		<div className="min-h-screen bg-linear-to-br from-slate-900 to-slate-800 text-white">
			...
			<div className={`max-w-6xl mx-auto px-4 pt-6 transition-all duration-300 ease-out ${disconnected ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2 pointer-events-none h-0 pt-0"}`}>
				{disconnected && (
