	...
	<div class="mx-auto flex w-full max-w-6xl flex-col gap-6">
		...
		>
			<div class="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
				<div>
					...
					<p class="mt-3 max-w-2xl text-base leading-7" style:color="var(--muted-text)">
						The Foxglove connection is active. This session can now own map, odometry,
						scan, and control state from the robot.
					</p>
				</div>
		...
		<section class="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
			...
			>
				...
				<div class="mt-5 grid gap-4 sm:grid-cols-2">
					<div
						...
						style:background="var(--surface-soft)"
					>
						<div class="text-xs font-semibold uppercase tracking-[0.2em]" style:color="var(--muted-text)">
							Status
						</div>
			...
			>
				...
				<p class="mt-3 text-sm leading-6" style:color="var(--muted-text)">
					These are the topics the bridge has advertised so far. This is the right place
					to gate the rest of the app before enabling map, teleop, and diagnostics.
				</p>
